...
-- [[ Basic Autocommands ]]
-- These are like event listeners
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    -- there are other events, like VeryLazy, to speed-up init time.
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Displays docs of symbol under cursor
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- There are additional nvim-treesitter modules that you can use to interactf
